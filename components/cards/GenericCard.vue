...
export default {
  props: {
    ...
    isfromAuthor: { type: Boolean, default: false, required: false }
  },
  computed: {
    imageRatioClass() {
...
.card {
  box-shadow: -7px 8px 21px -4px rgba(72, 65, 65, 0.77);
  -webkit-box-shadow: -7px 8px 21px -4px rgba(72, 65, 65, 0.77);
  -moz-box-shadow: -7px 8px 21px -4px rgba(72, 65, 65, 0.77);
}
