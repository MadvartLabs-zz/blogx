...
export default {
  siteName: 'DU BLOGS',
  tagline: 'DU Blogs এ আপনাকে স্বাগতম',
  featureImage: '/uploads/home-hero.jpg',
  logo: '../assets/logo.png', // 'logo-component', // or '/logo.svg' for regular image
  googleAnalytics: {
    on: true,
  ...
  disqus: {
    ...
    siteShortName: 'joykoly' // 'blog-danielkelly-io'
  },

  // Newsletter Subscribe
  newsletter: {
    on: true,
    heading: 'নিউজলেটারে সাবস্ক্রাইব করুন',
    btnText: 'সাবস্ক্রাইব',
    ...
    mailchimp: {
      on: true,
      formAction:
        'https://joykoly.us1.list-manage.com/subscribe/post?u=ad01c16940ad5060b082e10d5&amp;id=2f9d2c43d9'
    },
    custom: {
      on: false,
      formAction: ''
